...
public class CuboidClipboard {
    ...
    public void paste(EditSession editSession, Vector newOrigin, boolean noAir)
        ...
        paste(editSession, newOrigin, false, BlockID.AIR);
    }
     ...
     * @throws MaxChangedBlocksException
     */
    public void paste(EditSession editSession, Vector newOrigin, boolean entities, int... pasteNoneOfThese)
            throws MaxChangedBlocksException {
        place(editSession, newOrigin.add(offset), pasteNoneOfThese);
        if (entities) {
     ...
     * @throws MaxChangedBlocksException
     */
    public void place(EditSession editSession, Vector pos, int... pasteNoneOfThese) throws MaxChangedBlocksException {
        for (int x = 0; x < size.getBlockX(); ++x) {
            for (int y = 0; y < size.getBlockY(); ++y) {
            	here:
                for (int z = 0; z < size.getBlockZ(); ++z) {
